...
def is_adjacent_indexes(items: typing.List[typing.Any], index_a: int,
                        index_b: int):
...
def unnest(nested: typing.List[typing.List[typing.List[typing.Any]]]):
    """Flatten a list in the form `[[[a,b]], [[c,d]], [[e,f]]]` to `[[a,b], [c,d], [e,f]]`."""
    return [e[0] for e in nested]


def call_on_some(items: typing.List[typing.Any], indexes: typing.List[int],
...
def arrange_index_to_first(items: typing.List[typing.Any], index: int) -> list:
...
def determine_which_is_next(items: typing.List[typing.Any], index_a: int,
                            index_b: int) -> int:
