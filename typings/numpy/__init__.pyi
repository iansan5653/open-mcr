...
_DtypeLike = Union[
    ...
    List[Union[Tuple[Union[str, Tuple[str, str]], _DtypeLikeNested], Tuple[
        Union[str, Tuple[str, str]], _DtypeLikeNested, _ShapeLike], ]],
    # {'names': ..., 'formats': ..., 'offsets': ..., 'titles': ...,
    #  'itemsize': ...}
    # TODO: use TypedDict when/if it's officially supported
    Dict[str, Union[Sequence[str],  # names
...
class dtype:
    ...
    def __init__(self, obj: _DtypeLike, align: bool = ...,
                 copy: bool = ...) -> None:
        ...
...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    @overload
    def view(self, dtype: _DtypeLike,
    ...
    def getfield(self, dtype: Union[_DtypeLike, str],
                 offset: int = ...) -> ndarray:
        ...

    def setflags(self, write: bool = ..., align: bool = ...,
                 uic: bool = ...) -> None:
        ...
    ...
    @overload
    def resize(self, new_shape: Sequence[int], *,
               refcheck: bool = ...) -> None:
        ...
...
class datetime64:
    ...
    def __sub__(self,
                other: Union[timedelta64, datetime64, int]) -> timedelta64:
        ...
...
def zeros(shape: _ShapeLike,
          dtype: _DtypeLike = ...,
          order: Optional[str] = ...) -> ndarray:
    ...


def ones(shape: _ShapeLike,
         dtype: _DtypeLike = ...,
         order: Optional[str] = ...) -> ndarray:
    ...
...
# BELOW HERE ARE CUSTOM FOR THIS PROJECT (NOT IN ORIGINAL REPO)
...
def sort(a: ndarray) -> ndarray:
    ...

def concatenate(a: Iterable[ndarray]) -> ndarray:
    ...
...
class ma:
    @staticmethod
    def masked_array(array: ndarray, mask: ndarray) -> ma.MaskedArray:
        ...

    @staticmethod
    def filled(array: ma.MaskedArray, fill_value: float) -> ndarray:
        ...
